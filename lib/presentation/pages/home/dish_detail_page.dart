...
class _DishDetailPageState extends State<DishDetailPage> {
  ...
  void _addToCart() {
    ...
    if (dish != null) {
      _cartController.addToCart(dishId: dish.id, quantity: _quantity);
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Obx(() {
        if (_dishController.isLoading.value &&
            _dishController.selectedDish.value == null) {
