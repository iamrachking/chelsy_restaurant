...
class _OrderDetailPageState extends State<OrderDetailPage> {
  ...
  // Variable pour savoir si on vient du checkout
  ...
  void initState() {
    ...
    //  Vérifier si on vient du checkout
    _isFromCheckout = Get.parameters['fromCheckout'] == 'true';
  ...
  Future<bool> _onWillPop() async {
    if (_isFromCheckout) {
      // Si on vient du checkout, retourner à l'accueil
      Get.offAllNamed(AppRoutes.home);
      return false; // Ne pas fermer l'app
    }
    // Sinon, laisser le comportement par défaut (retour à la page précédente)
    return true;
  }
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          //  Personnaliser le bouton retour si on vient du checkout
          leading: _isFromCheckout
              ? IconButton(
          ...
          return SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('Plats', style: Theme.of(context).textTheme.titleLarge),
                const SizedBox(height: 8),
                ...
                const SizedBox(height: 16),
                //  Bouton retour à l'accueil si on vient du checkout
                if (_isFromCheckout)
                  CustomButton(
