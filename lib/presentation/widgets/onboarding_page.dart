...
class _OnboardingPageState extends State<OnboardingPage> {
  ...
  final List<OnboardingItem> _pages = [
    OnboardingItem(
      title: 'Savoureux',
      subtitle: '& Rapide',
      description: 'Explore nos plats délicieux, faits maison avec des ingrédients frais.',
    ...
    OnboardingItem(
      ...
      description: 'Règle ta commande en toute simplicité et en toute confiance.',
      icon: Icons.payment,
